            ...
            {products.map((product) => (
              ...
              >
                <div className="text-center mb-2">
                  <h3
                    className="font-black text-slate-900 mb-1 line-clamp-2"
                    style={{ fontSize: `${config.fontSize + 6}px`, fontWeight: 900 }}
                  >
                    {product.name}
                  </h3>
                  {product.color && (
                    <p
                      ...
                      style={{ fontSize: `${config.fontSize + 2}px`, fontWeight: 900 }}
                    >
                      Color: {product.color}
                    </p>
                  )}
                  {product.description && labelSize !== 'small' && (
                    <p
                      className="text-slate-700 font-bold line-clamp-1"
                      style={{ fontSize: `${config.fontSize}px`, fontWeight: 700 }}
                    >
                      {product.description}
                    </p>
                  )}
