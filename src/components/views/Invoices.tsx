...
import { supabase, Invoice, Customer, Product, CompanyProfile } from '../../lib/supabase';
import { Plus, Search, Eye, Trash2, Printer, ChevronDown, UserPlus, Scan } from 'lucide-react';
